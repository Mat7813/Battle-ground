...
%Il a pu nous aider au tout début à configurer git. Ainsi il a pu faire la commande "push" pour mettre les premiers fichiers c codés par Lazare sur le git.
...
\bibitem[6]{x6} \url https://wiki.libSDL.org/
